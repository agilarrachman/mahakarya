...
<script>
    $(document).ready(function() {
        ...
        $('.tambah').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/PotonganGaji/tambah_potonganGaji',
                method: 'post',
                data: {
                    aksi: aksi
                },
        ...
        $('.edit').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/PotonganGaji/edit_potonganGaji',
                method: 'post',
                data: {
                    potongan: potongan
                },
        ...
        $('.hapus').click(function() {
            ...
            var potongan = $(this).attr("potongan");
            $.ajax({
                url: '<?php echo base_url(); ?>admin/PotonganGaji/hapus_potonganGaji',
                method: 'post',
                data: {
                    potongan: potongan
                },
